...
CircleAvatar addFavoriteWidgets(
    FavoriteProvider favoriteProvider, String productId, BuildContext context) {
  return CircleAvatar(
    backgroundColor: Colors.grey.shade400.withOpacity(.25),
